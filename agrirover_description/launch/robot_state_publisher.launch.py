...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'agrirover_ws/src/agrirover_moveit_config/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'agrirover_ws/install/agrirover_moveit_config/share/agrirover_moveit_config/config',
        robot_name
    )
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='agrirover',
    ...
    DeclareLaunchArgument('flange_link', default_value='arm_link_2',
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = 'agrirover_description'
    urdf_filename = 'arm.urdf.xacro'
    rviz_config_filename = 'agrirover_description.rviz'
